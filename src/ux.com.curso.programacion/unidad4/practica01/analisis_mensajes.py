...
def main():
    ...
    print(f"Mediana de mensajes por hora: {mediana}")

if __name__ == "__main__":
    main()

#Al no haber un import de una biblioteca externa, el código no puede ejecutar funciones como np.mean, np.max, etc. Esto resultará en un error de NameError indicando que 'np' no está definido. Para solucionar esto, es necesario importar la biblioteca NumPy al inicio del código.